...
[]
ListMultimap(defaultdict(<class 'list'>, {'a': [1, 2, 2, 3, 4]}))
ListMultimap(defaultdict(<class 'list'>, {'a': [1, 2, 2, 3]}))
True
[1, 2, 2, 3]
ListMultimap(defaultdict(<class 'list'>, {'a': [1, 2, 2, 3, 5], 'b': [6]}))
ListMultimap(defaultdict(<class 'list'>, {'a': [1, 2, 2, 3, 5]}))
True
_________________________________________________________________________________________________________
set()
SetMultimap(defaultdict(<class 'set'>, {'a': {1, 2, 3, 4}}))
SetMultimap(defaultdict(<class 'set'>, {'a': {1, 2, 3}}))
True
{1, 2, 3}
SetMultimap(defaultdict(<class 'set'>, {'a': {1, 2, 3, 5}, 'b': {6}}))
SetMultimap(defaultdict(<class 'set'>, {'a': {1, 2, 3, 5}}))
True
_________________________________________________________________________________________________________
{}
DictMultimap(defaultdict(<class 'dict'>, {'a': {1: True, 2: True, 3: True, 4: True}}))
DictMultimap(defaultdict(<class 'dict'>, {'a': {1: True, 2: True, 3: True}}))
True
{1: True, 2: True, 3: True}
DictMultimap(defaultdict(<class 'dict'>, {'a': {1: True, 2: True, 3: True, 5: True}, 'b': {6: True}}))
DictMultimap(defaultdict(<class 'dict'>, {'a': {1: True, 2: True, 3: True, 5: True}}))
True
"""
