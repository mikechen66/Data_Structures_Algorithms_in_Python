...
It is an algorithm for finding the shortest path between all the pairs of vertices 
in a weighted graph. This algorithm follows the dynamic programming approach to 
...
def floyd_warshall(graph):
    ...
    consider only the vertices in the set {0, 1, 2, .. k-1} as inter-
    mediate vertices.
