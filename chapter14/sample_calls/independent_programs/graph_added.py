...
The graph is a representation of a simple graph using an adjacency map. There exist nested 
Classes for Vertex and Edge objects and useful methods for vertex and edge, edge incidence 
and vertex degree retrieval plus edge and vertex insertion
...
class Graph:
    ...
    def get_vertex(self, el):
        ...
        for vertex in self.vertices():
            if vertex.element() == el:
                return vertex
        return None
    # Rewrite the original edges_count() function 
    ...
    def insert_vertex(self, x=None):
        ...
        if self.is_directed:
            self._incoming[v] = {}
        return v
    # Modify the original insert_edge() method
